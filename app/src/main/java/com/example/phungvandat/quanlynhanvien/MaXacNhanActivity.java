...
public class MaXacNhanActivity extends AppCompatActivity {
    ...
    private void xuLyXacNhan() {
        ...
        if (String.valueOf(maXN).equals(maXacNhanTuPhone)) {
    ...
    private void addControls() {
        txtMaXacNhan = (EditText) findViewById(R.id.txtMatKhauXacNhan);
    ...
    private void xuLyGuiMaXacNhan() {
        ...
        registerReceiver(new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                ...
                Toast.makeText(MaXacNhanActivity.this, msg, Toast.LENGTH_LONG).show();
